...
outrootfile='file:OneNuM_0_200_cff_py_GEN_SIM_RECO_age_'+str(options.AgeingScenario)+'_PixDigiThr_'+str(options.PixDigiThr)+'_'+str(options.maxEvents)+'_evts_seed_'+str(options.MySeed)+'.root'
outntuplefile='OccupancyPlotTest_OneNuM_ntuple_age_'+str(options.AgeingScenario)+'_PixDigiThr_'+str(options.PixDigiThr)+'_'+str(options.maxEvents)+'_evts_seed_'+str(options.MySeed)+'.root'
