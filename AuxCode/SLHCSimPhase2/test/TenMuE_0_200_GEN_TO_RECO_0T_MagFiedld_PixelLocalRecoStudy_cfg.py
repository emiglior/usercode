...
# with command line options: Configuration/GenProduction/python/FourteenTeV/TenMuE_0_200_cfi.py --no_exec -s GEN,SIM,DIGI:pdigi_valid,L1,DIGI2RAW,RAW2DIGI,L1Reco,RECO --conditions auto:upgrade2017 --magField 0T --eventcontent FEVTDEBUG --beamspot NoSmear --geometry Extended2017 --relval 10000,100 --datatier GEN-SIM-RECO -n 500 --customise SLHCUpgradeSimulations/Configuration/combinedCustoms.cust_2017 --fileout file:TenMuE_0_200_cff_py_GEN_SIM_RECO.root
...
#    process.mix.input.fileNames = cms.untracked.vstring(['root://eoscms//eos/cms/store/caf/user/emiglior/SLHCSimPhase2/620_slhc17_patch1/Extended2023Muon/GEN-SIM/Thick_BPIX_0.100_FPIX_0.285/step1_MinBias_TuneZ2star_14TeV_pythia6_51kEvts.root']) 
    ...
    try:
        ...
        #firstPUEvent = int(options.MySeed * math.fabs(options.maxEvents) * int(options.PUScenario))
        #print "start sampling from",firstPUEvent
        #process.mix.input.firstEvent = cms.untracked.uint32(firstPUEvent)
