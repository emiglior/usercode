...
GeneralizedEndPointAnalysisOld::GeneralizedEndPointAnalysisOld(TFile * fout, const char * append) {
  ...
  if ( fout != 0 ) {
    ...
    char dir_title[40];
    sprintf(dir_title,"GeneralizedEndPointAnalysisOld%s",append);
...
GeneralizedEndPointAnalysisOld::~GeneralizedEndPointAnalysisOld(){
  outfile.close();
...
void GeneralizedEndPointAnalysisOld::analyze(const TLorentzVector & muNeg, const TLorentzVector & muPos, double weight){
